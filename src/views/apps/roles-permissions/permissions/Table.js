    ...
    <Row className='text-nowrap w-100 my-75 g-0 permission-header'>
      <Col xs={12} lg={4} className='d-flex align-items-center'>
        <div className='d-flex align-items-center justify-content-center justify-content-lg-start'>
          ...
          <label htmlFor='rows-per-page'>por paginas.</label>
        </div>
      </Col>
      <Col xs={12} lg={8}>
        <div className='d-flex align-items-center justify-content-lg-end justify-content-start flex-md-nowrap flex-wrap mt-lg-0 mt-1'>
          ...
          {/* <div className='mt-50 width-200 me-1 mt-sm-0 mt-1'>
            <Input
              ...
              <option value='administrator'>Usuarios Administradores</option>
              <option value='manager'>Afiliados</option>
...
const Table = () => {
  ...
  const renderModalSubtitle = () => {
    if (store.selected !== null) {
      return 'Edite el permiso según sus requisitos.'
    } else {
      return 'Permisos que puede usar y asignar a sus usuarios.'
    }
  }
  ...
  const renderForm = () => {
    if (store.selected === null) {
        ...
        <Row tag={Form} onSubmit={handleSubmit(onSubmit)}>
          <Col xs={12}>
            ...
            {errors && errors.permissionName && (
              <FormFeedback>Ingrese un nombre de permiso válido</FormFeedback>
            )}
          </Col>
          <Col xs={12} className='mt-75'>
            <div className='form-check'>
              ...
              <Label className='form-check-label' for='core-perm-checkbox'>
                Establecer como permiso principal
              </Label>
            </div>
          </Col>
      ...
      return (
        <Fragment>
          <Alert color='warning'>
            <h6 className='alert-heading'>Alerta!</h6>
            <div className='alert-body'>
              Al editar el nombre del permiso, puede romper el sistema
              funcionalidad de permisos. Por favor, asegúrese de estar
      ...
      <Modal
        ...
        <ModalBody
          ...
          <div className='text-center mb-2'>
            <h1 className='mb-1'>
              {store.selected !== null ? 'Editar' : 'Agregar nuevo'} permiso
            </h1>
