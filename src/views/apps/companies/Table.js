    ...
    <div className='invoice-list-table-header w-100 me-1 ms-50 mt-2 mb-75'>
      <Row>
        ...
        <Col
          ...
          flex-column pe-xl-1 p-0 mt-xl-0 mt-1'>
...
const CompaniesList = () => {
  ...
  //**status Options
  const statusOptions = [
    { label: 'Seleccione Estatus', number: 0, value: '' },
    { label: 'Inactivo', number: 2, value: 2 },
  ...
  return (
    <>
      <Card>
        <CardHeader>
          <CardTitle tag='h4'>Filtros de búsqueda empresa</CardTitle>
        </CardHeader>
        <CardBody>
          <Row>
            <Col md='4'>
      ...
      <Card className='overflow-hidden'>
        <div className='react-dataTable'>
          <CardHeader>
            <CardTitle tag='h4'> Lista de empresas</CardTitle>
          </CardHeader>
          <DataTable
            noHeader
            subHeader
