...
// ** Store & Actions
import { setModal, getData, FindBenefitCategory } from './store'
import { getData as getCompanies } from '../../apps/companies/store'
    ...
    <Fragment>
      ...
      <Card>
        <CardHeader className='border-bottom'>
          <CardTitle tag='h4'>Lista de categorias</CardTitle>
          <Button
        ...
        <div className='react-dataTable'>
          <DataTable
            ...
            responsive
            paginationServer
            columns={columns(toggleModal, companies)}
