...
// ** Store & Actions
import { setModal, getData, FindBenefit } from './store'
import { getData as getCategory } from '../category/store'
...
const BenefitList = () => {
  ...
  const category = useSelector(state => state.benefitCategory)
  ...
  //**status Options
  const statusOptions = [
    { label: 'Seleccionar Estatus', number: 0, value: '' },
    ...
    <Fragment>
      ...
      <Card>
        <CardHeader className='border-bottom'>
          <CardTitle tag='h4'>Lista de beneficio</CardTitle>
          <Button
        ...
        <div className='react-dataTable'>
          <DataTable
            ...
            columns={columns(toggleModal, category)}
